...
//             - Student class consists of 3 classes and 4 variables
    ...
    std::cout  << std::endl;
    std::cout  << std::endl;
    std::cout << "Hello!" << std::endl << "Your student data has been loaded. What would you like to do with it?" << std::endl;
    int running = 1;
    int count = 0;
    while(running == 1){
        if(count > 0){
        ...
        std::cout << "Enter 1 for a full report, enter 2 for a mini report, and 3 to exit." << std::endl;
        ...
        if(response == "1"){
            ...
            std::cout  << std::endl;
            std::cout  << std::endl;
        } else if (response == "3" || response == "exit"){
            running = 0;
        } else {
