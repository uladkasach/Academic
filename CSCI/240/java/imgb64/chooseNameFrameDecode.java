...
public class chooseNameFrameDecode extends JFrame {
    
    protected decodeFrame masterClass;
    protected String theDir;
    protected String theExt;
    protected static chooseNameFrameDecode thisFrame;
    ...
    public chooseNameFrameDecode(decodeFrame sentClass, String sentDir, String sentExt){
